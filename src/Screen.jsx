...
export default function Screen() {
    ...
    const cycle = useStore((state) => {return state.cycle})
    const addCycle = useStore((state) => {return state.addCycle})
  ...
  function updateForLevel0() {
      ...
      if(stage === "falling" && fallingRefs.size >= (rigidBodyRefs.current.length)) {
        setFalling(true)
      }
  }
